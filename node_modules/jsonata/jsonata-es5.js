...
var jsonata = function () {
  ...
  function evaluateApplyExpression(expr, input, environment) {
    ...
    return regeneratorRuntime.wrap(function evaluateApplyExpression$(_context15) {
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            return _context15.delegateYield(_evaluate(expr.lhs, input, environment), "t0", 1);
          ...
          case 1:
            ...
            return _context15.delegateYield(evaluateFunction(expr.rhs, input, environment, {
              context: lhs
            }), "t1", 4);
          ...
          case 7:
            return _context15.delegateYield(_evaluate(expr.rhs, input, environment), "t2", 8);
          ...
          case 11:
            ...
            return _context15.delegateYield(_evaluate(chainAST, null, environment), "t3", 13);

          case 13:
            chain = _context15.t3;
            return _context15.delegateYield(apply(chain, [lhs, func], null, environment), "t4", 15);
          ...
          case 18:
            return _context15.delegateYield(apply(func, [lhs], null, environment), "t5", 19);
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          ...
          case 8:
            ...
            return _context18.delegateYield(_loop(), "t1", 10);
          ...
          case 13:
            ...
            return _context18.delegateYield(apply(proc, evaluatedArgs, input, environment), "t2", 17);
          ...
          case 20:
            _context18.prev = 20;
            _context18.t3 = _context18["catch"](14);

            if (!_context18.t3.position) {
              // add the position field to the error
              _context18.t3.position = expr.position;
            }

            if (!_context18.t3.token) {
              // and the function identifier
              _context18.t3.token = procName;
            }
      ...
      while (1) {
        switch (_context19.prev = _context19.next) {
          ...
          case 9:
            ...
            return _context19.delegateYield(_evaluate(result.body.arguments[ii], result.input, result.environment), "t3", 12);
          ...
          case 17:
            return _context19.delegateYield(applyInner(next, evaluatedArgs, input, environment), "t5", 18);
      ...
      while (1) {
        switch (_context20.prev = _context20.next) {
          case 0:
            ...
            return _context20.delegateYield(applyProcedure(proc, validatedArgs), "t0", 5);
          ...
          case 8:
            ...
            return _context20.delegateYield(result, "t1", 13);
          ...
          case 16:
            ...
            return _context20.delegateYield(result, "t2", 20);
          ...
          case 26:
            _context20.prev = 26;
            _context20.t3 = _context20["catch"](0);

            if (proc) {
              if (typeof _context20.t3.token == 'undefined' && typeof proc.token !== 'undefined') {
                _context20.t3.token = proc.token;
              }

              _context20.t3.position = proc.position;
            }
  ...
  function jsonata(expr, options) {
    ...
    return {
      ...
      ast: function (_ast) {
        function ast() {
          return _ast.apply(this, arguments);
        }

        ast.toString = function () {
